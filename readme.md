...
| **Wk 05**  | [Layout Design using Bootstrap](lectures/lec10/), [GeoViz evaluation](https://developers.google.com/analytics/devguides/collection/gtagjs/)  ([*`reading`*](lectures/lec10/read.md)) | [Lab4: Geoviz Module](labs/lab04); [*Google Cloud Platform*](https://github.com/taluccia/earthengine.cloud.qgis.leaflet)                                    | Color, Topography ([*`reading`*](lectures/lec12/read.md))              | [Sketch](project/sketch.md)                                  |
| **Wk 06**  | SVG, Icons                                        | Lab5: [Coordinated View](http://geoviz.ceoas.oregonstate.edu/geog4572/labs/lab05/index.html) or [Storymap](https://github.com/jakobzhao/storymap)                  | Word cloud                     | Design Scheme (Color, label, icon, and multimedia,  etc.) |
