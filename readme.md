...
| **Wk 05**  | Layout Design using Bootstrap, GeoViz evaluation  ([*`reading`*](lectures/lec10/read.md)) | Lab4: Geoviz Module; [*Google Cloud Platform*](project/google-cloud-platform.md)                                    | Color, Topography              | Sketch; Interface Design                                  |
