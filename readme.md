...
| **Wk 02**  | Brainstorm                                       | GeoViz Programming Basics - Html, Css and jQuery ([*`reading`*](lectures/lec04/read.md)); [Lab2: GeoViz Programming Basic -Javascript](labs/lab02/) ([*`reading`*](labs/lab02/read.md)) | Interactive Maps using Leaflet | Team-up                                                   |
