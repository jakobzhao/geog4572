...
| **Wk 05**  | [Layout Design using Bootstrap, GeoViz evaluation](lectures/lec10/)  ([*`reading`*](lectures/lec10/read.md)) | [Lab4: Geoviz Module](labs/lab04); [*Mashup maps from Google Earth Engine to Web Map*](lectures/lec11/)                                    | Color, Topography ([*`reading`*](lectures/lec12/read.md))              | [Sketch](project/sketch.md)                                  |
