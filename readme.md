...
| **Wk 02**  | Brainstorm                                       | GeoViz Programming Fundamentals ([*`reading`*](lectures/lec04/read.md)); Lab2: Web programming ([*`reading`*](labs/lab02/read.md)) | Interactive Maps using Leaflet | Team-up                                                   |
