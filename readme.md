...
| **Wk 02**  | Brainstorm                                       | [GeoViz Programming Basics - Html, Css](lectures/lec04/part01/) and [jQuery](lectures/lec04/part02/) ([*`reading`*](lectures/lec04/read.md)); [Lab2: GeoViz Programming Basics](labs/lab02/) ([*`reading`*](labs/lab02/read.md)) | Interactive Maps using Leaflet | Team-up                                                   |
