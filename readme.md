...
| **Wk 04**  | [D3 II](lectures/lec06) ([*`reading`*](lectures/lec06/read.md))                                            | Lab3 cont’d; [*debugging*:bug:](https://scotch.io/tutorials/debugging-javascript-with-chrome-devtools-breakpoints)                     | D3 III ([D3 graphics](lectures/lec09/part01/), [DC.js](http://dc-js.github.io/dc.js/docs/stock.html)) ([*`reading`*](lectures/lec09/read.md))                         | Proposal revision; [:book:Name Convention](project/naming.md)                                         |
