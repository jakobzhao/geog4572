...
| **Wk 06**  | [Icons, Illustrators and Scalable Vector Graphics](lectures/lec13/)                                        | Lab5: [Coordinated View](http://geoviz.ceoas.oregonstate.edu/geog4572/labs/lab05/index.html) or [Storymap](https://github.com/jakobzhao/storymap)                  | Word cloud                     | [Design Scheme (Color, font, icon, and multimedia, etc.)](project/design_scheme.md) |
