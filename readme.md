...
| **Wk 05**  | [Layout Design using Bootstrap, GeoViz evaluation](lectures/lec10/)  ([*`reading`*](lectures/lec10/read.md)) | [Lab4: Geoviz Module](labs/lab04); [*Google Cloud Platform*](lectures/lec11/)                                    | [Color, Typography](lectures/lec12) ([*`reading`*](lectures/lec12/read.md))              | [Sketch (`Due: 05/8, 5pm`)](project/sketch.md)                                  |
| **Wk 06**  | [Icons, Illustrators and Scalable Vector Graphics](lectures/lec13/)                                        | [Lab5: Integrated Geovisualization](lab05/readme.md): [coordinated view](labs/lab05/coordinated/readme.md) or [storymap](labs/lab05/storymap/readme.md)                  | Word cloud                     | [Data Source](project/data.md); [Design Scheme (Color, font, icon, and multimedia, etc.)](project/design_scheme.md) |
