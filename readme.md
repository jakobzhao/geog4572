...
| **Wk 05**  | [Layout Design using Bootstrap](lectures/lec10/), [GeoViz evaluation](https://developers.google.com/analytics/devguides/collection/gtagjs/)  ([*`reading`*](lectures/lec10/read.md)) | [Lab4: Geoviz Module](labs/lab04); [*Google Cloud Platform*](https://github.com/taluccia/earthengine.cloud.qgis.leaflet)                                    | Color, Topography              | Sketch; Interface Design                                  |
